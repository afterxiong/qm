...
public class HintDevicesDialog extends BaseDialog {
    @Override
    public View layout(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.dialog_binding_device,container,false);
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HintDevicesDialog.this.dismiss();
            }
        });
        return view;
    }
