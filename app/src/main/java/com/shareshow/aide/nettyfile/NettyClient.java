...
import com.shareshow.aide.nettyfile.business.OnServerConnectListener;
...
public class NettyClient {
    ...
    public void connect(String ip,int port, OnServerConnectListener onServerConnectListener){
        if (mChannel != null && mChannel.isActive()){
            return ;
        }

        mServerAddress = new InetSocketAddress(ip,port);
            ...
            mBootstrap.group(mWorkerGroup)
                      ...
                      .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            pipeline.addLast("decoder", new ProtobufDecoder(ClientMessage.ProtoClientMessage.getDefaultInstance()));
        ...
        public void operationComplete(ChannelFuture pChannelFuture) throws Exception{
            if (pChannelFuture.isSuccess()){
                mChannel = pChannelFuture.channel();
                    ...
                    onServerConnectListener.onConnectSuccess(future);
                }
    ...
    public synchronized void send(ClientMessage.ProtoClientMessage msg, OnReceiveListener listener) {
        if (mChannel == null) {
