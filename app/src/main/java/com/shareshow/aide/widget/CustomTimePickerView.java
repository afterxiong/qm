...
/**
 * Created by xiongchengguang on 2018/3/14.
 */
...
public class CustomTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private CustomTimePickerView.OnTimeSelectListener timeSelectListener;//回调接口
    private CustomTimePickerView.OnTimeCancelListener timeCancelListener;
    ...
    //构造方法
    public CustomTimePickerView(CustomTimePickerView.Builder builder) {
        super(builder.context);
        this.timeSelectListener = builder.timeSelectListener;
        this.timeCancelListener = builder.timeCancelListener;
    ...
    public static class Builder {
        ...
        private CustomTimePickerView.OnTimeSelectListener timeSelectListener;
        private CustomTimePickerView.OnTimeCancelListener timeCancelListener;
        ...
        //Required
        public Builder(Context context, CustomTimePickerView.OnTimeSelectListener listener, CustomTimePickerView.OnTimeCancelListener cancelListener) {
            this.context = context;
            this.timeSelectListener = listener;
            this.timeCancelListener = cancelListener;
        }

        //Option
        public CustomTimePickerView.Builder setType(boolean[] type) {
            this.type = type;
            return this;
        }

        public CustomTimePickerView.Builder gravity(int gravity) {
            this.gravity = gravity;
            return this;
        }

        public CustomTimePickerView.Builder setSubmitText(String Str_Submit) {
            this.Str_Submit = Str_Submit;
            return this;
        }

        public CustomTimePickerView.Builder isDialog(boolean isDialog) {
            this.isDialog = isDialog;
            return this;
        }

        public CustomTimePickerView.Builder setCancelText(String Str_Cancel) {
            this.Str_Cancel = Str_Cancel;
            return this;
        }

        public CustomTimePickerView.Builder setTitleText(String Str_Title) {
            this.Str_Title = Str_Title;
            return this;
        }

        public CustomTimePickerView.Builder setSubmitColor(int Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public CustomTimePickerView.Builder setCancelColor(int Color_Cancel) {
         ...
         * @return
         */
        public CustomTimePickerView.Builder setDecorView(ViewGroup decorView) {
            this.decorView = decorView;
            return this;
        }

        public CustomTimePickerView.Builder setBgColor(int Color_Background_Wheel) {
            this.Color_Background_Wheel = Color_Background_Wheel;
            return this;
        }

        public CustomTimePickerView.Builder setTitleBgColor(int Color_Background_Title) {
            this.Color_Background_Title = Color_Background_Title;
            return this;
        }

        public CustomTimePickerView.Builder setTitleColor(int Color_Title) {
            this.Color_Title = Color_Title;
            return this;
        }

        public CustomTimePickerView.Builder setSubCalSize(int Size_Submit_Cancel) {
            this.Size_Submit_Cancel = Size_Submit_Cancel;
            return this;
        }

        public CustomTimePickerView.Builder setTitleSize(int Size_Title) {
            this.Size_Title = Size_Title;
            return this;
        }

        public CustomTimePickerView.Builder setContentSize(int Size_Content) {
         ...
         * @return
         */
        public CustomTimePickerView.Builder setDate(Calendar date) {
            this.date = date;
            return this;
        }

        public CustomTimePickerView.Builder setLayoutRes(int res, CustomListener customListener) {
            this.layoutRes = res;
            this.customListener = customListener;
            return this;
        }

        public CustomTimePickerView.Builder setRange(int startYear, int endYear) {
        ...
        public CustomTimePickerView.Builder setRangDate(Calendar startDate, Calendar endDate) {
         ...
         */
        public CustomTimePickerView.Builder setLineSpacingMultiplier(float lineSpacingMultiplier) {
         ...
         * @param dividerColor
         */
        public CustomTimePickerView.Builder setDividerColor(int dividerColor) {
         ...
         * @param dividerType
         */
        public CustomTimePickerView.Builder setDividerType(WheelView.DividerType dividerType) {
        ...
        public CustomTimePickerView.Builder setBackgroundId(int backgroundId) {
         ...
         */
        public CustomTimePickerView.Builder setTextColorCenter(int textColorCenter) {
         ...
         * @param textColorOut
         */
        public CustomTimePickerView.Builder setTextColorOut(int textColorOut) {
            this.textColorOut = textColorOut;
            return this;
        }

        public CustomTimePickerView.Builder isCyclic(boolean cyclic) {
            this.cyclic = cyclic;
            return this;
        }

        public CustomTimePickerView.Builder setOutSideCancelable(boolean cancelable) {
            this.cancelable = cancelable;
            return this;
        }

        public CustomTimePickerView.Builder setLunarCalendar(boolean lunarCalendar) {
            isLunarCalendar = lunarCalendar;
            return this;
        }

        public CustomTimePickerView.Builder setLabel(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
         ...
         * @return
         */
        public CustomTimePickerView.Builder setTextXOffset(int xoffset_year, int xoffset_month, int xoffset_day, int xoffset_hours, int xoffset_mins, int xoffset_seconds) {
        ...
        public CustomTimePickerView.Builder isCenterLabel(boolean isCenterLabel) {
        ...
        public CustomTimePickerView build() {
            return new CustomTimePickerView(this);
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_SUBMIT)) {
            ...
            if (timeCancelListener != null) {
                timeCancelListener.onTimeCancel(v);
            }
        }
        dismiss();
    }
