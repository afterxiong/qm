...
public class OpenAppUtils {
	...
	public static final int FILE_CODE =0x222;
	private Context context;

	public OpenAppUtils(Context context) {
		this.context = context;
	}

	public void openFiles(Activity act, String filesPath){
		...
		if (!type.equals("*/*")){
			try {
				act.startActivityForResult(intent,FILE_CODE);
			} catch (Exception e) {
				act.startActivityForResult(showOpenTypeDialog(filesPath),FILE_CODE);
			}
		} else {
			act.startActivityForResult(showOpenTypeDialog(filesPath),FILE_CODE);
		}
	...
	public void openFiles(String filesPath){
		   ...
		   if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
			   ...
			   Uri contentUri = FileProvider.getUriForFile(context, context.getPackageName() + ".fileProvider", new File(filesPath));
	...
	public void show(String filesPath){
	    ...
	    public static final String[][] MIME_MapTable =
            ...
            {".epub", "application/epub+file_icon_zip"},
            {".eri", "image/x-eri"},  
            {".es", "audio/echospeech"},  
