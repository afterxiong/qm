package com.shareshow.airpc.animutils;
...
public class AnimationsContainer {
    public int FPS = 20;  // 每秒播放帧数，fps = 1/t，t-动画两帧时间间隔
    ...
    //获取单例
    public static AnimationsContainer getInstance(int resId, int fps,Context context) {
        if (mInstance == null)
            mInstance = new AnimationsContainer();
        mInstance.setResId(resId, fps,context);
        return mInstance;
    }

    public void setResId(int resId, int fps, Context context){
        this.resId = resId;
        this.FPS = fps;
