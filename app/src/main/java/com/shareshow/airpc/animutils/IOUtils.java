...
public class IOUtils {
     ...
     *   Reader in = null;
     *   try {
     *       in = new FileReader("foo.file_icon_txt");
     *       in.read(data);
     ...
     *   InputStream in = null;
     *   try {
     *       in = new FileInputStream("foo.file_icon_txt");
     *       in.read(data);
     *       in.close(); //close errors are handled
     *   } catch (Exception e) {
     *       // error handling
     ...
     * try {
     *     out = new FileOutputStream("foo.file_icon_txt");
     *     out.write(data);
     *     out.close(); //close errors are handled
     * } catch (IOException e) {
     *     // error handling
     ...
     *   try {
     *       closeable = new FileReader("foo.file_icon_txt");
     *       // process closeable
     *       closeable.close();
     *   } catch (Exception e) {
     *       // error handling
