...
public class Defaults {
	protected static int inputBufferSize = 8192;
	protected static int dataChunkSize = 131072;  // do file I/O in 128k chunks 
...
//	protected static int ipRetrievalAttempts = 5;
	...
	public static final int SO_TIMEOUT_MS = 5000; // socket timeout millis
