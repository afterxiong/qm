...
public class CmdCWD extends FtpCmd implements Runnable {
	...
	public void run(){
		System.out.println("============CmdCWD==============="+input);
		String param = getParameter(input);
		System.out.println("============CmdCWD==============="+param);
		name=null;
		...
		mainblock: {
			...
			Globals.setChrootDir(new File(Constans.CHROOTDIR));
			/*newDir=new File(Constans.CHROOTDIR+param);
			if(!newDir.exists())
				newDir=new File(Constans.CHROOTDIR2+param);
