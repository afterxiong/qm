...
public class SessionThread extends Thread {
	...
	int authFails = 0;
	private boolean isShareFile=true;



	public long remoteFileSize=-1;
	private final  static int TIMEOUT =20000;

	public int getFtpClientVision() {
		return ftpClientVision;
	}

	public void setFtpClientVision(int ftpClientVision) {
		this.ftpClientVision = ftpClientVision;
	}

	private int ftpClientVision;
...
//	}
	...
	public String getRemoteIp(){
		String ip="";
		if(cmdSocket.getInetAddress()!=null){
			 ip=(cmdSocket.getInetAddress().toString()).split("/")[1];
		}
		return ip;
	}
