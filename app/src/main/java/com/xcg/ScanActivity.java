...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        enter_flag = getIntent().getIntExtra("enter_flag", 0);
    }
...
//            try {
                if(result!=null&&result.contains("http://www.shareshow.com.cn")){
                   // EventBus.getDefault().post(new EventScanResult(result));
...
//                    if (type.equals("1")){
//                        if(type.equals(String.valueOf(enter_flag))){
//                            Intent intent = new Intent(ScanActivity.this, RegisterActivity.class);
//                            intent.putExtra(SCAN_PHONE_RESULT, value);
...
//                            intent.putExtra(SCAN_IDS_RESULT, value);
//                            startActivity(intent);
//                            finish();
//                        }else{
//                            Toast.makeText(ScanActivity.this,"二维码不正确",Toast.LENGTH_SHORT).show();
...
//            }
//
//            String scanPhone = "15945655452";
//            Intent intent = new Intent(ScanActivity.this, MainActivity.class);
//           // intent.putExtra("scanPhone", scanPhone);
//            startActivity(intent);
              finish();
        }
    };
